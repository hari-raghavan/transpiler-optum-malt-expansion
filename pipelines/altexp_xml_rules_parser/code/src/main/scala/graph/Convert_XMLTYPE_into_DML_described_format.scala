...
object Convert_XMLTYPE_into_DML_described_format {
  def apply(context: Context, in: DataFrame): DataFrame = {
    ...
    //
    // <component>
    //       <name>Convert_XMLTYPE_into_DML_described_format</name>
    //       <type>xml-split</type>
    //       <layout>layout-Convert_XMLTYPE_into_DML_described_format</layout>
    ...
    //   string(1) newline = &quot;\n&quot;;
    // end;
    // metadata type = user_defined_list_rule_t ;</format></in-port>
    //
    //
    ...
    //   string(1) newline = &quot;\n&quot;;
    // end;
    // metadata type = user_defined_list_rule_t ;</reject><error>type error_info_V2_16 = record
    //   utf8 string(big endian integer(4)) component;
    //   big endian integer(4) port_index;
    //   utf8 string(big endian integer(4)) parameter;
    //   utf8 string(big endian integer(4)) message;
    ...
    // end;
    // type adc_error_info_vector_t = adc_error_info_t[4];
