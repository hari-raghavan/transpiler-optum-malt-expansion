...
object Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File_7 {
  ...
  def apply(context: Context): DataFrame =
    context.spark.read
      ...
      .schema(
        StructType(
          Array(
            StructField("alt_run_alt_dtl_id",    StringType, true),
            ...
            StructField("alt_ndc",               StringType, true)
          )
        )
      )
