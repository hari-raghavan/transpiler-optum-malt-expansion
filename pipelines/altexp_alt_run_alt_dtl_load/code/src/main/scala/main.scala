...
object Main {
  ...
  def apply(context: Context): Unit = {
    val df_Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File0 =
      if (
        ...
        Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File0(context)
      else null
      ...
      if (
        ...
        val df_Join_With_Input_Surrogate_Key_File__Join =
          Join_With_Input_Surrogate_Key_File__Join(
            context,
            df_Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File0,
            df_Transform_Logic
          )
    ...
    if (
      ...
      Load_Serial_log_file0(context, df_Handle_Serial_Logs)
    }
    ...
    if (
      ...
      Append_Mode0(context, df_Append_Mode_DateTimeNormalize)
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/altexp_alt_run_alt_dtl_load"
    )
    registerUDFs(spark)
