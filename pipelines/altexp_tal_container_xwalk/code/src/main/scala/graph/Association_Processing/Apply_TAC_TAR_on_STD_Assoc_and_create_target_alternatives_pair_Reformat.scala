...
object Apply_TAC_TAR_on_STD_Assoc_and_create_target_alternatives_pair_Reformat {
  def apply(context: Context, in: DataFrame, prod_dtl_df: DataFrame, expanded_UDL_wt_rl_priority_df: DataFrame, rule_prod_dtl_df: DataFrame): DataFrame = {
    ...
    val rule_prod_dtl_var = spark.sparkContext.broadcast(
      rule_prod_dtl_df
        .filter((col("qualifier_cd") === lit("GPI14")) && (col("operator") === lit("eq")))
    ...
    def apply_tar(
      ...
      var _prdcts            = _bv_all_zeros()
      var lv_prdcts          = _bv_all_zeros()
      var left_over_prdcts   = _bv_all_zeros()
      ...
      if (is_alt > 0) {
        ...
        udl_len = udl_prdcts.length
        contents = tar_prdcts_contents.slice(1, tar_prdcts_contents.length)
      }
    
      for (i ← 0 until udl_len) {
        _prdcts = _bv_all_zeros()
        tar_prdcts_mapping = Array.concat(tar_prdcts_mapping, Array.fill(1)(Row(Array[Row](), Array[Int]())))
        if (is_alt > 0) {
          if (shared_qualifier == "N/A") {
            ...
            for (p ← target_tar_prdcts_mapping.indices) {
              ...
              target_tar_prdcts_mapping(p).getAs[Array[Int]](1).foreach { idx ⇒
                    ...
                    for (n ← 0 until alt_len) {
                      ...
                      if (_bv_count_one_bits(lv_prdcts) > 0) {
                        tar_prdcts_mapping(i) = updateIndexInRow(
                          ...
                          1,
                          Array.concat(tar_prdcts_mapping(i).getAs[Array[Int]](1), Array.fill(1)(idx))
                        )
                        tar_prdcts_mapping(i) = updateIndexInRow(
                          tar_prdcts_mapping(i),
                          0,
                          Array.concat(
                            tar_prdcts_mapping(i).getAs[Array[Row]](0),
                            Array.fill(1)(
                              Row(
                                new java.math.BigDecimal(idx),
            ...
            if (is_override_incl > 0 && _bv_count_one_bits(udl_prdts) > 0) {
              tar_prdcts_mapping(i) = updateIndexInRow(
                ...
                Array.concat(
                  ...
                  Array.fill(1)(
                    Row(
                      new java.math.BigDecimal(tar_prdcts_mapping(i).getAs[Array[Row]](1).length),
            ...
            var udl_prdts = alt_udl_prdcts(i).getAs[Array[Byte]](0)
            target_tar_prdcts_mapping(i).getAs[Array[Int]](1).foreach { idx ⇒
              val tar_prdcts_contents = tar_prdcts.getAs[Seq[Row]](4).toArray
              val alt_contents        = tar_prdcts_contents(0).getAs[Seq[Row]](1).toArray
              if (is_override_incl > 0) {
                _prdcts = _bv_and(udl_prdts,          alt_contents(idx).getAs[Array[Byte]](2))
              ...
              if (_bv_count_one_bits(lv_prdcts) > 0) {
                tar_prdcts_mapping(i) =
                  updateIndexInRow(tar_prdcts_mapping(i),
                                    1,
                                    Array.concat(tar_prdcts_mapping(i).getAs[Array[Int]](1), Array.fill(1)(m))
                  )
                tar_prdcts_mapping(i) = updateIndexInRow(
                  tar_prdcts_mapping(i),
                  0,
        ...
        val buckets = tar_prdcts_mapping(i).getAs[Array[Row]](0)
        for (k ← 0 until tar_prdcts_mapping(i).getAs[Array[Row]](0).length) {
              ...
              if (
                ...
                if (
                  _bv_count_one_bits(buckets(k).getAs[Array[Byte]](4)) > 0 && !(_bv_count_one_bits(
                    ...
                    && _bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](6)) > 0) &&
                  !(buckets(k).getAs[Row](7).getAs[Array[Array[Byte]]](1).nonEmpty || buckets(k)
                    .getAs[Row](7)
                    .getAs[Array[Array[Byte]]](3)
                    .nonEmpty || buckets(k).getAs[Row](7).getAs[Array[Array[Byte]]](5).nonEmpty || buckets(k)
                    .getAs[Row](7)
                    .getAs[Array[Array[Byte]]](7)
                    .nonEmpty)
                ) {
                ...
                if (
                  _bv_count_one_bits(buckets(k).getAs[Array[Byte]](5)) > 0 && !(_bv_count_one_bits(
                    ...
                    && _bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](6)) > 0) &&
                  !(buckets(k).getAs[Row](8).getAs[Array[Array[Byte]]](1).nonEmpty || buckets(k)
                    .getAs[Row](8)
                    .getAs[Array[Array[Byte]]](3)
                    .nonEmpty || buckets(k).getAs[Row](8).getAs[Array[Array[Byte]]](5).nonEmpty || buckets(k)
                    .getAs[Row](8)
                    .getAs[Array[Array[Byte]]](7)
                    .nonEmpty)
                ) {
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](0)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    sorted_prdcts = updateIndexInRow(
                      sorted_prdcts,
                      1,
                      Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](1), Array.fill(1)(_prdcts))
                    )
                    sorted_prdcts =
                      updateIndexInRow(sorted_prdcts,         0, _bv_difference(sorted_prdcts.getAs[Array[Byte]](0), _prdcts))
                    buckets(k) = updateIndexInRow(buckets(k), 7, sorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](2)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    sorted_prdcts = updateIndexInRow(
                      sorted_prdcts,
                      3,
                      Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](3), Array.fill(1)(_prdcts))
                    )
                    sorted_prdcts =
                      updateIndexInRow(sorted_prdcts,         2, _bv_difference(sorted_prdcts.getAs[Array[Byte]](2), _prdcts))
                    buckets(k) = updateIndexInRow(buckets(k), 7, sorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](4)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    sorted_prdcts = updateIndexInRow(
                      sorted_prdcts,
                      5,
                      Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](5), Array.fill(1)(_prdcts))
                    )
                    sorted_prdcts =
                      updateIndexInRow(sorted_prdcts,         4, _bv_difference(sorted_prdcts.getAs[Array[Byte]](4), _prdcts))
                    buckets(k) = updateIndexInRow(buckets(k), 7, sorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](6)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    sorted_prdcts = updateIndexInRow(
                      sorted_prdcts,
                      7,
                      Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](7), Array.fill(1)(_prdcts))
                    )
                    sorted_prdcts =
                      updateIndexInRow(sorted_prdcts,         6, _bv_difference(sorted_prdcts.getAs[Array[Byte]](6), _prdcts))
                    buckets(k) = updateIndexInRow(buckets(k), 7, sorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](0)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      1,
                      Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](1).toArray, Array.fill(1)(_prdcts))
                    )
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      0,
                      _bv_difference(unsorted_prdcts.getAs[Array[Byte]](0), _prdcts)
                    )
                    buckets(k) = updateIndexInRow(buckets(k), 8, unsorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](2)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      3,
                      Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](3), Array.fill(1)(_prdcts))
                    )
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      2,
                      _bv_difference(unsorted_prdcts.getAs[Array[Byte]](2), _prdcts)
                    )
                    buckets(k) = updateIndexInRow(buckets(k), 8, unsorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](4)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      5,
                      Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](5), Array.fill(1)(_prdcts))
                    )
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      4,
                      _bv_difference(unsorted_prdcts.getAs[Array[Byte]](4), _prdcts)
                    )
                    buckets(k) = updateIndexInRow(buckets(k), 8, unsorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
                ...
                if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](6)) > 0) {
                  ...
                  if (_bv_count_one_bits(_prdcts) > 0) {
                    ...
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      7,
                      Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](7), Array.fill(1)(_prdcts))
                    )
                    unsorted_prdcts = updateIndexInRow(
                      unsorted_prdcts,
                      6,
                      _bv_difference(unsorted_prdcts.getAs[Array[Byte]](6), _prdcts)
                    )
                    buckets(k) = updateIndexInRow(buckets(k), 8, unsorted_prdcts)
                    _prdcts = _bv_all_zeros()
                  }
          ...
          if (_bv_count_one_bits(buckets(k).getAs[Array[Byte]](4)) > 0) {
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](0)) > 0) {
              sorted_prdcts =
                updateIndexInRow(sorted_prdcts,
                                  1,
                                  Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](1),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](2)) > 0) {
              sorted_prdcts =
                updateIndexInRow(sorted_prdcts,
                                  3,
                                  Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](3),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](4)) > 0) {
              sorted_prdcts =
                updateIndexInRow(sorted_prdcts,
                                  5,
                                  Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](5),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](7).getAs[Array[Byte]](6)) > 0) {
              sorted_prdcts =
                updateIndexInRow(sorted_prdcts,
                                  7,
                                  Array.concat(sorted_prdcts.getAs[Array[Array[Byte]]](7),
            ...
            buckets(k) = updateIndexInRow(
              ...
              6,
              Array.concat(
                buckets(k).getAs[Array[Array[Byte]]](6),
                sorted_prdcts.getAs[Array[Array[Byte]]](1),
                sorted_prdcts.getAs[Array[Array[Byte]]](3),
                sorted_prdcts.getAs[Array[Array[Byte]]](5),
                sorted_prdcts.getAs[Array[Array[Byte]]](7)
              )
            )
            ...
            if (
              sorted_prdcts
                .getAs[Array[Byte]](1)
                .isEmpty && sorted_prdcts.getAs[Array[Byte]](3).isEmpty && sorted_prdcts
                .getAs[Array[Byte]](5)
              ...
              buckets(k) = updateIndexInRow(
                buckets(k),
                6,
                Array.concat(buckets(k).getAs[Array[Array[Byte]]](6), Array.fill(1)(buckets(k).getAs[Array[Byte]](4)))
              )
            }
          }
          ...
          if (_bv_count_one_bits(buckets(k).getAs[Array[Byte]](5)) > 0) {
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](0)) > 0) {
              unsorted_prdcts = updateIndexInRow(
                unsorted_prdcts,
                1,
                Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](1),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](2)) > 0) {
              unsorted_prdcts = updateIndexInRow(
                unsorted_prdcts,
                3,
                Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](3),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](4)) > 0) {
              unsorted_prdcts = updateIndexInRow(
                unsorted_prdcts,
                5,
                Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](5),
            ...
            if (_bv_count_one_bits(buckets(k).getAs[Row](8).getAs[Array[Byte]](6)) > 0) {
              unsorted_prdcts = updateIndexInRow(
                unsorted_prdcts,
                7,
                Array.concat(unsorted_prdcts.getAs[Array[Array[Byte]]](7),
            ...
            buckets(k) = updateIndexInRow(
              ...
              Array.concat(
                buckets(k).getAs[Array[Array[Byte]]](6),
                unsorted_prdcts.getAs[Array[Array[Byte]]](1),
                unsorted_prdcts.getAs[Array[Array[Byte]]](3),
                unsorted_prdcts.getAs[Array[Array[Byte]]](5),
                unsorted_prdcts.getAs[Array[Array[Byte]]](7)
              )
            )
            ...
            if (
              ...
              buckets(k) = updateIndexInRow(
                buckets(k),
                6,
                Array.concat(buckets(k).getAs[Array[Array[Byte]]](6), Array.fill(1)(buckets(k).getAs[Array[Byte]](5)))
              )
            }
          }
          ...
          if (
            ...
            buckets(k) = updateIndexInRow(
              buckets(k),
              6,
              Array.concat(buckets(k).getAs[Array[Array[Byte]]](6), Array.fill(1)(buckets(k).getAs[Array[Byte]](3)))
            )
          }
        }
    ...
    def apply_gpi14_sorting(
      ...
      var lv_udl_index          = new java.math.BigDecimal(0)
          ...
          loop.breakable {
            tac_contents.getAs[Seq[Row]](2).foreach { rec ⇒
              ...
              if (lv_tac_target_dl_bits.length > 0) {
                ...
                first_hit_priority = rec.getAs[java.math.BigDecimal](2).intValue()
    
                var i        = tac_idx + 1
                val contents = tac_contents.getAs[Seq[Row]](2).toArray
                while (
                  i < contents.length && first_hit_priority == contents(i).getAs[java.math.BigDecimal](2).intValue()
                ) {
                ...
                alt_bucket_vec.foreach { bucket1 ⇒
                  tar_idx = bucket1.getAs[java.math.BigDecimal](0).intValue()
                  alt_idx = bucket1.getAs[java.math.BigDecimal](1).intValue()
                  val alt_prdcts_all_prio =
                    tar_roa_df_alt(tar_idx).getAs[Seq[Seq[Array[Byte]]]](1).toArray.map(_.toArray)
                  ...
                  if (
                    ...
                    bucket1.getAs[Array[Array[Byte]]](6).foreach { alt_prds ⇒
                      unmatching_udl_prd = _bv_all_zeros()
                      ...
                      if (alt_dl_bits.nonEmpty) {
                        ...
                        alt_rank =
                          if (lv_udl_index != bucket1.getAs[java.math.BigDecimal](3)) udl_prdct_count + 1
                          else alt_rank + alt_dl_bits.length
                        lv_udl_index = bucket1.getAs[java.math.BigDecimal](3)
                      }
                    }
                  }
                  len_now = len_alt - 1
                  ...
                  lv_tac_target_dl_bits.foreach { p ⇒
                    unsorted_target_prdct_dtl = Array.concat(
                      ...
                      Array.fill(1)(
                        Row(
                          p,
                          new java.math.BigDecimal(bucket_index),
                          new java.math.BigDecimal(udl_index),
                          "", // for tar_udl_nm since result is assigned to target_alt_rank_t type
                          new java.math.BigDecimal(tac_index),
                          alt_rank_vec,
                          "Y",
                          new java.math.BigDecimal(rec.getAs[String](3))
                        )
                      )
                    )
                  }
    ...
    def apply_udl_sort(unmatching_udl_prd: Array[Byte], udl_nm: String, tar_roa_df_alt_cntnt: Array[Array[Byte]]) = {
      ...
      var lv_udl_nm = _string_lrtrim(udl_nm)
      val prod_dtl  = prod_dtl_var.value
    ...
    val process_udf = udf({ (in: Row) =>
      ...
      var lv_tac_contents =
        Row(Array[Byte](),
            Array[Byte](),
            Row(Array[Byte](), Array[Byte](), new java.math.BigDecimal(0), new java.math.BigDecimal(0)),
            new java.math.BigDecimal(0)
        )
      var lv_target_prdcts           = _bv_all_zeros()
      ...
      if (in.getAs[java.math.BigDecimal]("tal_id") == new java.math.BigDecimal(0)) {
        ...
        var alt_contents_0 = contents(0).getAs[Seq[Row]](1).toArray
        for (c ← 0 until length_of_contents) {
          ...
          for (a ← 0 until length_of_alt_contents) {
            ...
            alt_contents_0(a) =
              updateIndexInRow(alt_contents_0(a), 2, _bv_or(alt_contents_0(a).getAs[Array[Byte]](2), step_alt_prdcts))
          }
          contents(c) = updateIndexInRow(contents(c), 1, alt_contents)
          contents(0) = updateIndexInRow(contents(0), 1, alt_contents_0)
        }
      ...
      if (in.getAs[String]("tal_assoc_type_cd").toInt == 1) {
        ...
        for (i ← 0 until tac_contents.length) {
          lv_target_prdcts =
            if (tar_prdcts.getAs[java.math.BigDecimal](7).intValue() > 0)
              tac_contents(i).getAs[Array[Byte]]("target_prdcts")
          ...
          if (_bv_count_one_bits(lv_target_prdcts) > 0 && _bv_count_one_bits(lv_alt_prdcts) > 0) {
            if (tac_contents(i).getAs[java.math.BigDecimal]("xtra_proc_flg").intValue() > 0) {
                ...
                if (_bv_count_one_bits(_target_prdcts) > 0 && _bv_count_one_bits(_alt_prdcts) > 0) {
                  contents = Array.concat(
                    ...
                    Array.fill(1)(
                      Row(_target_prdcts,
                          _alt_prdcts,
                          rec.getAs[java.math.BigDecimal]("ST_flag"),
                          rec.getAs[java.math.BigDecimal]("priority")
                      )
                    )
                  )
              ...
              contents = Array.concat(
                ...
                Array.fill(1)(
                  Row(
                    lv_target_prdcts,
                    lv_alt_prdcts,
                    tac_contents(i).getAs[Seq[Row]](2).head.getAs[java.math.BigDecimal](2),
                    tac_contents(i).getAs[Seq[Row]](2).head.getAs[java.math.BigDecimal](3)
                  )
                )
              )
        ...
        if (_bv_count_one_bits(_all_tac_target_prdcts) > 0) {
          ...
          lv_tac_contents =
            updateIndexInRow(lv_tac_contents, 3, new java.math.BigDecimal(convertToInt(contents.length > 1)))
        } else {
        ...
        if (in.getAs[Seq[Row]]("alt_constituent_prdcts").length > 0) {
          ...
          if (in.getAs[String]("shared_qual") != "N/A") {
            ...
            target_tar_prdcts_mapping.foreach { target_prd ⇒
              var bucket_index = 0
              target_prd.getAs[Array[Row]](0).foreach { bucket ⇒
                ...
                alt_tar_prdcts_mapping.foreach { alt_prd ⇒
                  alt_bucket_vec = Array.concat(
                    ...
                    alt_prd
                      .getAs[Array[Row]](0)
                      .filter(r ⇒ r.getAs[java.math.BigDecimal](0) == bucket.getAs[java.math.BigDecimal](0))
                  )
                }
                ...
                if (alt_bucket_vec.length > 0) {
                  alt_bucket_vec = alt_bucket_vec
                    .sortBy(r ⇒
                      (r.getAs[java.math.BigDecimal](0).intValue(),
                        r.getAs[java.math.BigDecimal](1).intValue(),
                        r.getAs[java.math.BigDecimal](2).intValue()
                      )
                    )
                  unsorted_target_prdct_dtl = apply_gpi14_sorting(
                    target_dl_bits,
                    bucket_index,
                    bucket.getAs[java.math.BigDecimal](2).intValue(),
                  ...
                  target_dl_bits.foreach { p ⇒
                    target_wo_alt_prdct_dtl = Array.concat(
            ...
            for (y ← 0 until alt_tar_prdcts_mapping.length) {
              tar_idx_vec = alt_tar_prdcts_mapping(y).getAs[Array[Int]](1).sorted.distinct
              store_bucket_idx_t =
                Array.concat(store_bucket_idx_t,
                              Array.fill(1)(Row(new java.math.BigDecimal(y), Array[java.math.BigDecimal]()))
                )
              index_vec = Array.concat(index_vec, Array.fill(1)(y))
              for (z ← 0 until tar_idx_vec.length) {
                pos = target_tar_prdcts_mapping(y).getAs[Array[Int]](1).indexOf(tar_idx_vec(z))
                target_dl_bits = Array[Int]()
                alt_bucket_vec = alt_tar_prdcts_mapping(y)
                  .getAs[Array[Row]](0)
                  .filter(r ⇒
                    r.getAs[java.math.BigDecimal](0)
                      .intValue() == tar_idx_vec(z) && r.getAs[java.math.BigDecimal](2).intValue() == y
                  )
    
                val buckets = target_tar_prdcts_mapping(y).getAs[Array[Row]](0)
                buckets(pos).getAs[Array[Array[Byte]]](6).foreach { prds ⇒
                  target_dl_bits = Array.concat(target_dl_bits, _bv_indices(prds))
                  store_bucket_idx_t(y) = updateIndexInRow(
                    store_bucket_idx_t(y),
                    1,
                    Array.concat(store_bucket_idx_t(y).getAs[Array[java.math.BigDecimal]](1),
                                  Array.fill(1)(new java.math.BigDecimal(pos))
                    )
                  )
                }
                if (in.getAs[String]("shared_qual") != "GPI14") {
                  unsorted_target_prdct_dtl = apply_gpi14_sorting(
                    target_dl_bits,
                    pos + 1,
                    buckets(pos).getAs[java.math.BigDecimal](2).intValue(),
                  ...
                  val loop = new Breaks
                  loop.breakable {
                    lv_tac_contents.getAs[Array[Row]](2).foreach { rec ⇒
                      if (tac_target_dl_bits.length > 0) {
                        lv_tac_target_dl_bits = _bv_indices(
                          _bv_and(buckets(pos).getAs[Array[Byte]](3), rec.getAs[Array[Byte]](0))
                        )
                        if (lv_tac_target_dl_bits.length > 0) {
                          alt_bucket_vec.foreach { bucket1 ⇒
                            if (
                              _bv_count_one_bits(bucket1.getAs[Array[Byte]](4)) > 0 || _bv_count_one_bits(
                                bucket1.getAs[Array[Byte]](5)
                              ) > 0
                            ) {
                              bucket1.getAs[Array[Array[Byte]]](6).foreach { alt_prds ⇒
                                val alt_prdcts_all_prio_seq =
                                  tar_roa_df_alt(bucket1.getAs[java.math.BigDecimal](0).intValue())
                                    .getSeq[Seq[Array[Byte]]](2)
                                val alt_prdcts_all_prio =
                                  alt_prdcts_all_prio_seq.map(_.toArray).toArray
                                var tar_roa_df_alt_cntnt =
                                  alt_prdcts_all_prio(bucket1.getAs[java.math.BigDecimal](1).intValue())
                                unmatching_udl_prd = _bv_and(alt_prds, rec.getAs[Array[Byte]](1))
                                alt_dl_bits =
                                  apply_udl_sort(unmatching_udl_prd, bucket1.getAs[String](11), tar_roa_df_alt_cntnt)
                                if (alt_dl_bits.length > 0) {
                                  alt_rank_vec = Array.concat(
                                    alt_rank_vec,
                                    Array.fill(1)(Row(alt_rank, alt_dl_bits, "", "", bucket1.getAs[String](11)))
                                  )
                                  alt_rank = alt_rank + bucket1.getAs[Array[Array[Byte]]](6).length
                                }
                              }
                            }
                          }
                            ...
                            lv_tac_target_dl_bits.foreach { p ⇒
                              unsorted_target_prdct_dtl = Array.concat(
                                ...
                                Array.fill(1)(
                                  Row(
                                    p,
                                    new java.math.BigDecimal(pos + 1),
                                    buckets(pos).getAs[java.math.BigDecimal](2),
                                    "",
                                    new java.math.BigDecimal(tac_index),
                                    alt_rank_vec,
                                    "Y",
            ...
            for (i ← 0 until target_tar_prdcts_mapping.length) {
              val buckets = target_tar_prdcts_mapping(i).getAs[Array[Row]](0)
              if (index_vec.contains(i)) {
                for (j ← 0 until buckets.length) {
                  if (
                    !store_bucket_idx_t(i).getAs[Array[java.math.BigDecimal]](1).contains(new java.math.BigDecimal(j))
                  ) {
                    buckets(j).getAs[Array[Array[Byte]]](6).foreach { prod_grp ⇒
                      target_wo_alt_prdct_dtl = Array.concat(
                        target_wo_alt_prdct_dtl,
                ...
                for (j ← 0 until buckets.length) {
                  target_wo_alt_prdct_dtl = Array
                    .concat(
                      target_wo_alt_prdct_dtl,
                      _bv_indices(_bv_vector_or(buckets(j).getAs[Array[Array[Byte]]](6)))
                        .map(p ⇒
                          Row(
                            p,
                            new java.math.BigDecimal(0),
        ...
        if (in.getAs[String]("shared_qual") != "N/A") {
          for (a ← 0 to alt_tar_prdcts_mapping.length) {
            alt_tar_prdcts_mapping(a).getAs[Array[Row]](0).foreach { bucket ⇒
              val alt_prdcts_all_prio_seq =
                tar_roa_df_alt(bucket.getAs[java.math.BigDecimal](0).intValue()).getSeq[Seq[Array[Byte]]](2)
              val alt_prdcts_all_prio =
                alt_prdcts_all_prio_seq.map(_.toArray).toArray
              var tar_roa_df_alt_cntnt = alt_prdcts_all_prio(bucket.getAs[java.math.BigDecimal](1).intValue())
    
              bucket.getAs[Array[Array[Byte]]](6).foreach { prds ⇒
                alt_prdcts_rank_vec = Array.concat(
                  alt_prdcts_rank_vec,
                  Array.fill(1)(
                    Row(alt_rank, apply_udl_sort(prds, bucket.getAs[String](11), tar_roa_df_alt_cntnt), "", "")
                  )
                )
                alt_rank = alt_rank + _bv_count_one_bits(prds)
              }
              val target_prdcts = in.getSeq[Array[Byte]](7).toArray
              target_prdct_dtl = Array.concat(
                target_prdct_dtl,
          ...
          alt_tar_prdcts_mapping.foreach { alt_prd ⇒
            alt_prd.getAs[Array[Row]](0).foreach { bucket ⇒
              val alt_prdcts_all_prio_seq =
                tar_roa_df_alt(bucket.getAs[java.math.BigDecimal](0).intValue()).getSeq[Seq[Array[Byte]]](2)
              val alt_prdcts_all_prio =
                alt_prdcts_all_prio_seq.map(_.toArray).toArray
      ...
      Row(
        in.getAs[java.math.BigDecimal]("tal_id"),
        ...
        StructField(
          ...
          ArrayType(
            StructType(List(
              ...
              StructField("bucket_index", DecimalType(38, 0), true),
              StructField("udl_index", DecimalType(38, 0), true),
              StructField("tar_udl_nm", StringType, true),
              StructField("tac_index", DecimalType(38, 0), true),
              StructField(
                "alt_prdcts_rank",
                ArrayType(
                  StructType(List(
