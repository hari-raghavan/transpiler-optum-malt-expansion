...
object Main {
  ...
  def apply(context: Context): Unit = {
    val df_Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File1 =
      if (
        ...
        Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File1(context)
      else null
      ...
      if (
        ...
        val df_Join_With_Input_Surrogate_Key_File__Join =
          Join_With_Input_Surrogate_Key_File__Join(
            context,
            df_Join_With_Input_Surrogate_Key_File__Input_Surrogate_Key_File1,
            df_Transform_Logic
          )
    ...
    if (
      ...
      Load_Serial_log_file1(context, df_Handle_Serial_Logs)
    }
    ...
    if (
      ...
      Output_Surrogate_Key_File_Creation__Output_Surrogate_Key_File1(
        context,
        df_Output_Surrogate_Key_File_Creation__Fetching_Required_Fields
      )
    if (
      (_root_.io.prophecy.abinitio.ScalaFunctions._not(
        _root_.io.prophecy.abinitio.ScalaFunctions.convertToBoolean(
      ...
      Append_Mode1(context, df_Append_Mode_DateTimeNormalize)
  }
  ...
  def main(args: Array[String]): Unit = {
    ...
    spark.conf.set("prophecy.metadata.pipeline.uri",
                   "pipelines/altexp_alt_run_target_dtl_load"
    )
    registerUDFs(spark)
