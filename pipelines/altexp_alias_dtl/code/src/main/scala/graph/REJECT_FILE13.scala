...
string("\\\\x01", 20) alias_name ;
decimal("\\\\x01", 0, maximum_length=39) qual_priority = 99 ;
string("\\\\x01", 10) qual_id_type_cd = NULL ;
string("\\\\x01", 14) qual_id_value = NULL ;
string("\\\\x01", 70) search_txt ;
string("\\\\x01", 70) replace_txt = NULL ;
