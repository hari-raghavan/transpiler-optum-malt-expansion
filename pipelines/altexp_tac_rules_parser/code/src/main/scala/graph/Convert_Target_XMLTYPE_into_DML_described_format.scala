...
object Convert_Target_XMLTYPE_into_DML_described_format {
  def apply(context: Context, in: DataFrame): DataFrame = {
    ...
    //
    // <component>
    //       <name>Convert_Target_XMLTYPE_into_DML_described_format</name>
    //       <type>xml-split</type>
    //       <layout>layout-Convert_Target_XMLTYPE_into_DML_described_format</layout>
